...
function activateOnScroll() {
    ...
    percentOne.classList.toggle("animate-tab-desk", window.scrollY + 500 > sectionFourTop)
    percentOne.classList.toggle("animate-mob", window.scrollY > 3350)
    percentTwo.classList.toggle("animate-tab-desk", window.scrollY + 500 > sectionFourTop)
    percentTwo.classList.toggle("animate-mob", window.scrollY > 3400)
    percentThree.classList.toggle("animate-tab-desk", window.scrollY + 500 > sectionFourTop)
    percentThree.classList.toggle("animate-mob", window.scrollY > 3450)
    percentFour.classList.toggle("animate-tab-desk", window.scrollY + 500 > sectionFourTop)
    percentFour.classList.toggle("animate-mob", window.scrollY > 3500)
    percentFive.classList.toggle("animate-tab-desk", window.scrollY + 500 > sectionFourTop)
    percentFive.classList.toggle("animate-mob", window.scrollY > 3550)
    percentSix.classList.toggle("animate-tab-desk", window.scrollY + 500 > sectionFourTop)
    percentSix.classList.toggle("animate-mob", window.scrollY > 3600)
    percentSeven.classList.toggle("animate-tab-desk", window.scrollY + 500 > sectionFourTop)
    percentSeven.classList.toggle("animate-mob", window.scrollY > 3650)
    percentEight.classList.toggle("animate-tab-desk", window.scrollY + 500 > sectionFourTop)
    percentEight.classList.toggle("animate-mob", window.scrollY > 3700)
    percentNine.classList.toggle("animate-tab-desk", window.scrollY + 500 > sectionFourTop)
    percentNine.classList.toggle("animate-mob", window.scrollY > 3750)
    percentTen.classList.toggle("animate-tab-desk", window.scrollY + 500 > sectionFourTop)
    percentTen.classList.toggle("animate-mob", window.scrollY > 3800)
    percentEleven.classList.toggle("animate-tab-desk", window.scrollY + 500 > sectionFourTop)
    percentEleven.classList.toggle("animate-mob", window.scrollY > 3850)
    percentTwelve.classList.toggle("animate-tab-desk", window.scrollY + 500 > sectionFourTop)
